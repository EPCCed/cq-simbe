...
cq_status only_measure_first_site(const size_t NQUBITS, qubit * qr,
  const size_t NMEASURE, cstate * cr, qkern_map * reg);
cq_status no_measure_qkern(const size_t NQUBITS, qubit * qr, const size_t NMEASURE, cstate * cr,
  qkern_map * reg);
...
cq_status overly_long_qkern_name(const size_t NQUBITS, qubit * qr,
  const size_t NMEASURE, cstate * cr, qkern_map * reg);
cq_status immediate_qabort(const size_t NQUBITS, qubit * qr, const size_t NMEASURE, cstate * cr,
  qkern_map * reg);
