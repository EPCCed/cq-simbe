...
int get_next_available_qregistry_slot() {
  ...
  if (qregistry.num_registers == __DEVICE_MAX_NUM_QUREGS__) return -1;
...
int device_alloc_qureg(void * par) {
...
int device_dealloc_qureg(void * par) {
